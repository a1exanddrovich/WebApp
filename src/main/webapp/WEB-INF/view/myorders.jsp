                        ...
                        <div class="section__card">
                            <div class="app__info">
                                ...
                                <div class="app__info-text">
                                    ...
                                    <fmt:formatDate value="${order.getArrivalDate()}" type="date" dateStyle="short"
                                                    timeStyle="short" var="arr"/>
                                ...
                                <div class="app__info-text">
                                    ...
                                    <fmt:formatDate value="${order.getDepartureDate()}" type="date" dateStyle="short"
                                                    timeStyle="short" var="dep"/>
...
<div class="container">
    ...
    <ctg:pagination commandName="myOrders" totalPages="${pageNumber}" currentPage="${currentPage}" nextTitle="${next}"
...
<c:if test="${orderDeleted != null}">
    <fmt:message key="label.deleteSuccess" var="mes"/>
    <script>
...
<c:if test="${editedSuccessfully != null}">
    <fmt:message key="label.editSuccess" var="mes"/>
    <script>
        window.onload = function () {
            alert("${mes}");
        }
