    ...
    <div class="container">
        <section class="section">
            <div class="section__container">
                <form class="section__form" action="controller?command=adminAddRoom" method="post">
                    <input class="form__input" type="text" placeholder="Hotel id" name="hotelId" autofocus required>
                    <input class="form__input" type="text" placeholder="Class" name="class" required>
